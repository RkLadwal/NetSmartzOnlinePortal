            ...
            "columnDefs": [
                {
                    ...
                    "render": function (data, type, full, meta) {
                        if (data != null) {
                            let editCat = '<a href="/user/managecat/' + data + '"><i class="fa fa-edit cursor-pointer" title="' + full.data + '"></a></i></a>  ';
                            var deleteCat = '<a href="/user/deletecategory/' + data + '"><i class="fa fa-trash cursor-pointer" title="' + full.data + '"></a></i></a>';
